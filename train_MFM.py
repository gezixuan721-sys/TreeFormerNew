...
parser = argparse.ArgumentParser(description='Train (MFM version + seed)')
parser.add_argument(
    '--data-dir',
...
parser.add_argument('--run-name', default='Treeformer_MFM', help='run name for wandb interface/logging')
